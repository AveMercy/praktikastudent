            ...
            {mode === 'theory' && (
                <article className="space-y-16">
                    ...
                    <section className="relative pl-12 border-l-2 border-blue-500/30">
                        ...
                        <h3 className="text-2xl font-bold text-white mb-6">Организация файлов</h3>
...
export default Navbar;`} />
                    ...
                    <section className="relative pl-12 border-l-2 border-blue-500/30">
                        ...
                        <TheoryText>
                            Так как у нас нет бэкенда и БД, откуда мы бы подтягивали данные, создадим простую главную страницу с баннером.
                        </TheoryText>
