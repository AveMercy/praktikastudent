            ...
            {mode === 'theory' && (
                <article>
                    ...
                    <section className="mb-12 mt-12">
                        ...
                        <TheoryText>
                            Для разработчика в Figma есть три главные зоны:
                        </TheoryText>

                        <div className="space-y-6 mt-6">
                            <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5">
                                <h4 className="text-blue-400 font-bold mb-2 underline decoration-blue-500/20 underline-offset-4">Layers (Слои) слева</h4>
                            ...
                            <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5">
                                <h4 className="text-white font-bold mb-2">Frame (Холст) в центре</h4>
                                <TheoryText className="text-sm">
                                    Место, где происходит магия.
                                </TheoryText>
                            </div>

                            <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/5">
                                <h4 className="text-blue-400 font-bold mb-2 underline decoration-blue-500/20 underline-offset-4">Inspect Panel (Панель свойств) справа</h4>
                                <TheoryText className="text-sm">
