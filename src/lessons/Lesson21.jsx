            ...
            {mode === 'practice' && (
                <div className="space-y-12">
                    ...
                    <section className="relative pl-12 border-l-2 border-blue-500/30">
                        ...
                        <TheoryText>
                            Запустите IntelliJ IDEA и создайте еще один пустой проект. Назовите его как вам угодно, например: <code className="text-blue-400">vashe-nazvanie-backend</code>.
                        </TheoryText>
                    ...
                    <section className="relative pl-12 border-l-2 border-blue-500/30">
                        <div
                            className="absolute -left-4 top-0 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center font-bold text-white shadow-lg shadow-blue-600/40">2
                        </div>
